...
public class TC04_CheckoutTest {
    ...
    public void checkoutStepOneTC() throws IOException {
        new P01_LoginPage(DriverFactory.getDriver())
                ...
                .fillingInformationCheckout(FIRSTNAME, LASTNAME, ZIPCODE).clickOnContinueButton();
        LogsUtils.info(FIRSTNAME + "||" + LASTNAME + "||" + ZIPCODE);
        Assert.assertTrue(Utility.verifyURL(DriverFactory.getDriver(), DataUtils.getPropertyData("environment", "Checkout_URL")));
    }
